...
function Program(props:any){
    ...
    const events = [
        ...
        },
        {
            ...
            extra:"Please note, Uber and Lyft will not be able to pick you up from Bethel Rock. Please be sure to arrange your transportation to and from the venue prior to the event."
        },
    ]
